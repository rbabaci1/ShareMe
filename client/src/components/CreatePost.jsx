...
const CreatePost = () => {
  ...
  return (
    <div className='relative flex flex-col justify-center w-full items-center lg:h-4/5 lg:h-full mt-24'>
      {savingPost && (
        <div className='absolute bg-gray-300 bg-opacity-40 top-0  w-full'>
          <Spinner />
        </div>
      )}
      ...
      >
        {fields && (
          <p className='text-red-500 font-bold text-center text-xl transition-all duration-250 ease-in'>
            Please fill all fields ;)
          </p>
        )}
      </div>

      <div className='flex lg:flex-row flex-col justify-center items-center bg-white lg:p-5 p-3 lg:w-4/5  w-full rounded-2xl'>
